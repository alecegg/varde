...
pub fn search(
    ...
    for bundle in bundles {
        ...
        for crate::walk::WalkedFile { path, frontmatter, .. } in found {
...
fn matches_all(frontmatter: &serde_yaml::Value, filters: &[(String, String)]) -> bool {
    filters
        .iter()
...
mod tests {
    ...
    fn custom_extension_field_is_filterable() {
        ...
        write(&dir, "hot.md", &concept("recall_priority: high\n", "# hot\n"));
        write(&dir, "cold.md", &concept("recall_priority: low\n", "# cold\n"));
    ...
    fn nested_subdirectory_concepts_are_found() {
        ...
        write(&sub, "leaf.md", &concept("status: deprecated\n", "# leaf\n"));
