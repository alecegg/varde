...
Breadth-first checklist for the growth loop (`references/plan-grow-doc.md`) plus
...
**External interface check:** If the destination touches something other
...
(`references/plan-grow-doc.md`) — don't add it to the final completeness check below as an
afterthought.
...
3. Ask the **final completeness check**: point at the plan file rather than re-stating
   ...
   confirmation before continuing without more questions.
