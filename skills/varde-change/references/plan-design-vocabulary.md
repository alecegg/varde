# Design terms: deep modules

Use these terms when designing or restructuring code. A deep module hides a
lot of behavior behind a small interface. Use this reference for standards,
architecture reviews, and open interface decisions during planning.
...
- **Depth** — use at the interface: the amount of behaviour a caller (or test) can exercise per unit of interface they have to learn. A module is **deep** when a large amount of behaviour sits behind a small interface, **shallow** when the interface is nearly as complex as the implementation.
...
- **Depth as ratio of implementation-lines to interface-lines** (Ousterhout): rewards padding the implementation. Use depth-as-use instead.
