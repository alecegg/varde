...
This section is read-only. Resume a handoff with `varde-knowledge reflect`,
which owns the resume procedure. Status displays raw frontmatter as written;
link freshness is recomputed at resume time, not here.
